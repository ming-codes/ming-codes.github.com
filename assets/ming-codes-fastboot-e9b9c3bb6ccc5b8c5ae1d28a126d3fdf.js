define("ming-codes/initializers/ajax",["exports"],function(e){"use strict"
...
najax(e)}
e.default={name:"ajax-service",initialize:function(e){e.register("ajax:node",r,{instantiate:!1}),e.inject("adapter","_ajaxRequest","ajax:node"),e.inject("adapter","fastboot","service:fastboot")}}}),define("ming-codes/initializers/error-handler",["exports"],function(e){"use strict"
