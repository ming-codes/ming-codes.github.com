...
var a=e.clock={now:function(){return(new Date).getTime()}},s=a.now})
define("ember-animated/-private/debug",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
var t=void 0
...
case 12:e.next=8
break
case 14:case"end":return e.stop()}},e,this)})}]),n}()})
define("ember-animated/services/motion",["exports","ember-animated/-private/ember-scheduler","ember-animated","ember-animated/components/animated-beacon"],function(e,t,r,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
...
Object.defineProperty(e,"__esModule",{value:!0})
e.versionRegExp=/\d[.]\d[.]\d/,e.shaRegExp=/[a-z\d]{8}/}),define("ember-get-config/index",["exports","ming-codes/config/environment"],function(e,t){"use strict"
...
this._super.apply(this,arguments)
var a=Ember.get(this,"moment"),s=e.length,u=[],l=[]
return 1===s?l.push(e[0]):2===s&&(u.push(e[0]),l.push(e[1])),(r=this.morphMoment(a.moment.apply(a,u),{locale:i,timeZone:o})).isSame.apply(r,l.concat([n]))})})})
