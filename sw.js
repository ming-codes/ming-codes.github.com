...
s&&i&&caches.delete(n)})})}function t(e,t){return!!t.find(function(t){return t.test(decodeURI(e))})}self.CACHE_BUSTER="1524114868210|0.9617067272661979",self.addEventListener("install",function(e){return self.skipWaiting()}),self.addEventListener("activate",function(e){return self.clients.claim()})
var n=["assets/ming-codes-fastboot-e9b9c3bb6ccc5b8c5ae1d28a126d3fdf.js","assets/ming-codes-8b452b6c8458411c1c64551152a0e35d.css","assets/ming-codes-487ddd47ab45485d6a3ea1896a1176e7.js","assets/vendor-cb587864e2d03b72320aa90c864ca6c8.css","assets/vendor-143ee2efe5d3c711aac82105810dae7c.js"],s="esw-asset-cache-1",i=n.map(function(e){return new URL(e,self.location).toString()}),c=function(){caches.open(s).then(function(e){return e.keys().then(function(t){t.forEach(function(t){-1===i.indexOf(t.url)&&e.delete(t)})})})}
...
var a=[],r=[]
self.INDEX_FILE_HASH="6b69d5c249f6c26d0870c80aa4d7a2bf"
